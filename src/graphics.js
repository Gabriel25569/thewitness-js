    ...
    drawSnake (snake) {
        ...
        if (snake != null) {
            ...
            if (snake.direction == DIRECTION.TOP || snake.direction == DIRECTION.BOTTOM) {
                ...
                this._drawCircle(coord.x, coord.y + snake.movement, Math.floor(pathSize / 1.5), "#A2A2A2", ctx);
                this._drawCircle(coord.x, coord.y + snake.movement, Math.floor(pathSize / 2), "#FFFFFF", ctx);
            } else {
                this._drawLine(coord.x, coord.y, coord.x + snake.movement, coord.y, this._theme.snake, pathSize, ctx);
                this._drawCircle(coord.x + snake.movement, coord.y, Math.floor(pathSize / 1.5), "#A2A2A2", ctx);
                this._drawCircle(coord.x + snake.movement, coord.y, Math.floor(pathSize / 2), "#FFFFFF", ctx);
            }
        }
    }
